    ...
    >
      ...
      <div className="relative z-10 container mx-auto px-4 text-center">
        <div className="max-w-4xl mx-auto space-y-8 animate-fadeIn">
          {/* Main Heading */}
          <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl xl:text-8xl font-bold mb-4 px-4">
          ...
          {/* Role */}
          <p className="text-xl md:text-2xl lg:text-3xl text-gray-800 dark:text-gray-100 font-medium">
            Full-Stack Developer & UI/UX Designer
          </p>

          {/* Typing Animation Tagline */}
          <div className="min-h-[80px] flex items-center justify-center px-4">
            <p className="text-base md:text-lg lg:text-xl text-gray-700 dark:text-gray-200 max-w-2xl">
              {typedText}
              <span className="inline-block w-0.5 h-5 md:h-6 bg-orange-600 dark:bg-amber-400 ml-1 animate-pulse" />
            </p>
          </div>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center pt-8">
            ...
            <Button
              size="lg"
              variant="outline"
              className="bg-white dark:bg-gray-800 text-orange-600 dark:text-orange-300 border-2 border-orange-600 dark:border-orange-400 hover:bg-orange-50 dark:hover:bg-orange-900/30 font-semibold px-8 py-6 text-lg shadow-lg"
              onClick={() => {
